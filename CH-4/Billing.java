public class Billing {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The total for four photobooks that cost $17.50 is $" + bill);
        bill = computeBill(10.00, 6, 20.00);
        System.out.println("The total for six photobooks that cost $10.00 with a $20 coupon is $" + bill);
    }
